...
POLARIS_OIDC_AUTH_SERVER_URL=http://keycloak.${KEYCLOAK_NAMESPACE}.svc.cluster.local/realms/${KEYCLOAK_REALM:-frigg-data-platform}
TRINO_OIDC_ISSUER=http://keycloak.${KEYCLOAK_NAMESPACE}.svc.cluster.local/realms/${KEYCLOAK_REALM:-frigg-data-platform}
